  ...
  const pickNameplate = async (candidate: File | null) => {
    ...
    try {
      ...
      if (details.appliance_type) {
        const match = matchApplianceType(details.appliance_type);
    ...
    <div>
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-[1fr_1fr]">
        <label className="block">
          <span className="mb-1.5 block font-display text-[13px] font-semibold">What is it?</span>
